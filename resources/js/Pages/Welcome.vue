...
<template>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <div
            class="relative flex min-h-screen flex-col justify-between selection:bg-[#FF2D20] selection:text-white"
        >
            <div class="relative w-full max-w-full px-6 lg:max-w-7xl">
                <header
                    class="flex flex-col items-center justify-between gap-2 py-10 lg:grid-cols-3"
                >
